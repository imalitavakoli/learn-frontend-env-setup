...
It's a **JavaScript task runner** which helps you automate & enhance your workflow.
 ...
 5. After you have a "*package.json*" file for your project, and also created and a "*gulpfile.js*" file at the root of your project and beside the "*package.json*" file ("*gulpfile.js*" file is a file which you configure all of the needed tasks that should be done for your project inside of it. [Click here](https://gulpjs.com/docs/en/getting-started/javascript-and-gulpfiles) to learn more about it), then run `gulp` to run your project's tasks and you're all done!
